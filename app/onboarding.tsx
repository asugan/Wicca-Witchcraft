...
import { setNotificationsEnabled, setOnboardingCompleted } from "@/db/repositories/settings-repository";
      ...
      >
        <View style={modalStyles.overlay}>
          <View style={modalStyles.container}>
            ...
            >
              {isEnabling ? (
                <ActivityIndicator size="small" color={SLIDE_BACKGROUNDS.slide1} />
              ) : (
